...
?>
                <tr>
                    ...
                    <th><?php echo $res['pickupslot'] ?></th>
                    <th><?php echo $res['phone_number'] ?></th>
                    <th><?php echo $res['status'] ?></th>
                    <th><?php echo $res['payment_done'] ?></th>
                    <th><?php echo $res['payment_in_rs'] ?></th>
                    <th><button class="btn-primary btn"> <a style="color:white;" href="Update_orders.php?id=<?php echo $res['id']; ?>">Update</a> </button></th>
                    <th><button class="btn-danger  btn"> <a style="color:white;" href="delete_orders.php?id=<?php echo $res['id']; ?>">Delete</a> </button></th>
