...
<head>
    ...
    <title>Admin_Login | FRESH START</title>
</head>
...
<body>
    ...
    <div class="logo">
     ...
     <div style="text-align: center;" class="admin_login">
        <h2
            style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;margin-bottom:30px">
            ADMIN LOGIN</h2>
    </div>
    

    <div class="signup_form" style=" display: flex; justify-content: center;">
    ...
    if(isset($_POST['submit'])){
        ...
        $username_search = " SELECT * FROM `admin_verify` WHERE username ='$username' ";
        ...
        if($username_count){
            ...
            if($db_pass == $password){
                ...
                <div style="text-align:center;margin-top:12px;" class="alert alert-danger" role="alert">
                     Password doesn't match <a href="signup.php" class="alert-link"> </a>
                 </div
                 <?php
            }
        }
